...
List<Session> welcomeFromJson(String str) => List<Session>.from(json.decode(str).map((x) => Session.fromJson(x)));

String welcomeToJson(List<Session> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
